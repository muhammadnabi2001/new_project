                        ...
                        <table class="table table-striped" style="border: 5px;">
                            ...
                            <tbody id="userTableBody">
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px solid #ddd; padding: 8px; word-wrap: break-word; max-width: 150px;">{{ $topshiriq->title }}</td>
                                    <td style="border: 1px solid #ddd; padding: 8px; word-wrap: break-word; max-width: 200px;">{{ $topshiriq->description }}</td>
                                    ...
                                    <td style="border: 1px solid #ddd; padding: 8px;">{{ $topshiriq->category->name }}</td>
                                    <td style="border: 1px solid #ddd; padding: 8px;">
