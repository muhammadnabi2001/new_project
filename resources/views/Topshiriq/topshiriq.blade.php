                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ asset('files/' . $topshiriq->file) }}" 
                                           style="text-decoration: none; display: inline-flex; align-items: center; justify-content: center; width: 30px; height: 30px; border: 2px solid #007bff; border-radius: 4px; color: #007bff;" 
                                           target="_blank">
